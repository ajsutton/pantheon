...
public class RocksDbConfiguration {
  ...
  public RocksDbConfiguration(
      final Path databaseDir, final int maxOpenFiles, final int maxBackgroundCompactions, final LRUCache cache, final String label) {
  ...
  public static class Builder {
    ...
    public RocksDbConfiguration build() {
      ...
      return new RocksDbConfiguration(databaseDir, maxOpenFiles, maxBackgroundCompactions, cache, label);
    }
  }
}
