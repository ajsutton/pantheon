...
public class RentBalanceOperation extends AbstractOperation {

  public RentBalanceOperation(final GasCalculator gasCalculator) {
    super(0x47, "RENTBALANCE", 1, 1, false, 1, gasCalculator);
  }
  ...
  public void execute(final MessageFrame frame) {
    ...
    if (account == null) {
      ...
      frame.pushStackItem(Int256.of(account.getRentBalance()).getBytes());
    }
  }
}
