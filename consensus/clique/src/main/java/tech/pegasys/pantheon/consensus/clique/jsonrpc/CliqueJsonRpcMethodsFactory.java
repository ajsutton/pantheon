...
public class CliqueJsonRpcMethodsFactory implements JsonRpcMethodFactory {
    ...
    public Map<String, JsonRpcMethod> createJsonRpcMethods(final Collection<RpcApi> jsonRpcApis) {
        ...
        final CliqueGetReportValidatorBlockProduction cliqueGetReportValidatorBlockProduction =
                new CliqueGetReportValidatorBlockProduction(blockchainQueries, voteTallyCache, jsonRpcParameter);
        ...
        rpcMethods.put(cliqueGetReportValidatorBlockProduction.getName(), cliqueGetReportValidatorBlockProduction);
        return rpcMethods;
    }
